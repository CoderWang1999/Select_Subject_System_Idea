...
public class TeacherController extends BladeController {
	...
	public R save(@ApiParam(value = "数量", required = true) @RequestParam(required = true) Integer amount) {
		Teacher teacher = new Teacher();
		teacher.setStudentAmount(amount);
	...
	public R update(@ApiParam(value = "id", required = true) @RequestParam(required = true) Long id,
					@ApiParam(value = "数量", required = true) @RequestParam(required = true) Integer amount) {
